...
module.exports = function(logger, poolConfig){
	...
	logger.debug('========= poolConfig.coin.name : ' + poolConfig.coin.name);
	...
	logger.debug('Mysql host ' + mposConfig.host + '， port ' + mposConfig.port + ', user ' + mposConfig.user
                + ', password ' + mposConfig.password + ', database ' + mposConfig.database);
